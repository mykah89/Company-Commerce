...
[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(Company.Commerce.Web.App_Start.FontAwesomeBundleConfig), "RegisterBundles")]
...
namespace Company.Commerce.Web.App_Start
{
	public class FontAwesomeBundleConfig
	{
		public static void RegisterBundles()
		{
			...
			BundleTable.Bundles.Add(new StyleBundle("~/Content/fontawesome").Include("~/Content/fonts/fontawesome/font-awesome.css"));
		}
	}
}